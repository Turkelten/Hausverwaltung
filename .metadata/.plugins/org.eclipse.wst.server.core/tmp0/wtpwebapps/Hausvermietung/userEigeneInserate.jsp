...
<body>
	...
	<div class="page">
		<jsp:include page="sidebarUserProfil.jsp" />
			<div class="user-page">
			 	<div class="userform">
			 		<h2>Eigene Inserate</h2><br/>
					  <div class="userinserate">
					  	<table>
					  		<tr>
					  			<th>
					  				<label style="font-size: 2rem">Bezeichnung</label>
					  			</th>
					  			<th>
 							...
 							<c:forEach var="current" items="${ inserate }" >
 								<tr>
 								<td>
								...
								<td>
									...
									<td>
										<form action="HandleInseratServlet" method="post">
											<input style="display: none" type="text" name="inseratid" value="${ current.id }">
											<button type="submit" name="button" value="change">Ändern</button>
											<button type="submit" name="button" value="delete">Löschen</button>								    	
									    </form>
								    </td>
								</tr>								
							</c:forEach>	
