...
public class Haus {
	...
	public float zimmer;
	public Boolean einbaukueche;
	public float kaltmiete;
	public float nebenkosten;
	public Adresse adresse;
	
	public Haus(String beschreibung, float groesse, float zimmer, Boolean einbaukueche, float kaltmiete, float nebenkosten, String hausnummer, String plz, String ort, String strasse) {
	...
	public void setZimmer(float zimmer) {
		this.zimmer = zimmer;
	}
	...
	public float getKaltmiete() {
		return kaltmiete;
	}

	public void setKaltmiete(float kaltmiete) {
		this.kaltmiete = kaltmiete;
	}
